...
class TestBuildServices:
    ...
    def test_dry_run_uses_single_adapter(self):
        ...
        # Dry-run mode creates 1 adapter (apple_calendar)
    ...
    def test_default_creates_all_targets(self):
        ...
        # Default creates adapters for each allowed target
...
class TestMainSyncPending:
    ...
    def test_dry_run_with_pending(self):
        ...
        assert rc == 0
        # exact processed count depends on adapter matching; at minimum returns 0+
